	...
	_fnc_D41_WetterWerte =
	{
		if (isDedicated) then
		{
			...
			if(D41_ChanceN <= 5) then
			{
				...
				if(D41_WMod == 0)	then {D41_Nebel = [0.8, 0.1,15];	D41_Regen = 0.2;	D41_Vorschau = 0.4;};
				if(D41_WMod == 1)	then {D41_Nebel = [0.7, 0.1,15];	D41_RegenCounter = 0;}; //geht so, akzeptabler Nebel
				if(D41_WMod == 2)	then {D41_Nebel = [0.6, 0.1,30];	D41_RegenCounter = 0;};
				if(D41_WMod == 3)	then {D41_Nebel = [0.5, 0.1,30];	D41_Regen = 0.2;	D41_Vorschau = 0.5;};
				if(D41_WMod == 4)	then {D41_Nebel = [0.4, 0.1,30];	D41_RegenCounter = 0;}; //geht so, akzeptabler Nebel
				if(D41_WMod == 5)	then {D41_Nebel = [0.1, 0.1,30];	D41_Regen = 0.4;	D41_Wellen = 1;	D41_Vorschau = 0.5;}; //Hoch halt
			};

			if(D41_ChanceN >=6 && D41_ChanceN <= 25 && D41_RegenCounter == 0) then
			{
			...
			if(D41_ChanceN >=6 && D41_ChanceN <= 25 && D41_RegenCounter == 1) then {D41_ChanceN = 31};

			if(D41_ChanceN >=26 && D41_ChanceN <= 85) then
			{
				D41_Nebel = [0,0,0]; D41_Wellen = 0; D41_Vorschau = 0.2; D41_Wind = [5, 5, true]; D41_Regen = 0; D41_RegenCounter = 0;
				D41_WMod = round(random 9);
			...
			if(D41_ChanceN >=86 && D41_ChanceN <= 100) then
			{
